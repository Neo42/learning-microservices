package com.neo42.loans.controller;

import com.neo42.loans.constants.LoansConstants;
import com.neo42.loans.dto.ErrorResponseDto;
import com.neo42.loans.dto.LoansDto;
import com.neo42.loans.dto.ResponseDto;
...
public class LoansController {
  ...
  @Operation(summary = "Create Loan details", description = "Create new loan inside EazyBank")
  @ApiResponses({
  ...
  @Operation(
      ...
      description = "Update loan details based on a mobile number")
  @ApiResponses({
    @ApiResponse(responseCode = "200", description = "HTTP status: OK"),
